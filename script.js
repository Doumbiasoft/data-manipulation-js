...
console.log(`Are all numbers divisible by 5?  ${yesOrNo}`);

// Check if the first number is larger than the last. Cache the result in a variable.

const isFirstNumberLargerThanLastNumber = n1 > n4;
yesOrNo = isFirstNumberLargerThanLastNumber ? "Yes" : "No";
console.log(`Is the first number ${n1} larger than the last ${n4}? ${yesOrNo}`);
...
console.log(`the remainder of ${multiplyResult}/${n4} is: ${remainder}`);

// Change the way that isOver25 calculates so that we do not need to use the NOT operator (!) in other logic comparisons. Rename the variable as appropriate.

const isLessThan25 = n1 < 25 || n2 < 25 || n3 < 25 || n4 < 25;
yesOrNo = isLessThan25 ? "Yes" : "No";
console.log(`Are all numbers less than 25? ${yesOrNo}`);
